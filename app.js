...
const STYLES = `
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    nav{display:flex;justify-content:space-between;align-items:center;padding:1.2rem;background:#061a06;border-bottom:2px solid #39ff14;position:sticky;top:0;z-index:100;box-shadow:0 0 20px rgba(57,255,20,.1)}
    ...
    button,.btn{background:transparent;border:2px solid #39ff14;color:#39ff14;padding:.6rem 1.2rem;font-family:'Space Mono',monospace;border-radius:8px;cursor:pointer;text-decoration:none;display:inline-block}
    ...
    .player-bar{position:fixed;bottom:0;left:0;right:0;background:#061a06;border-top:2px solid #39ff14;padding:1rem;display:none;align-items:center;gap:.8rem;z-index:1000;box-shadow:0 0 20px rgba(57,255,20,.1)}
